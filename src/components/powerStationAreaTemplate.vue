...
export default {
  ...
  methods: {
    ...
    getProvince () {
      this.$http({
        url: this.$http.adornUrl('powerStationOperation/gtpowerstation/getStationProvince'),
        method: 'post',
    ...
    getCity (id) {
      ...
      this.$http({
        url: this.$http.adornUrl('powerStationOperation/gtpowerstation/getStationCityByProvince'),
        method: 'post',
    ...
    getArea (id) {
      ...
      this.$http({
        url: this.$http.adornUrl('powerStationOperation/gtpowerstation/getStationAreaByCity'),
        method: 'post',
        data: this.$http.adornData(data)
      }).then(({data}) => {
