...
gulp.task('css-wrap', function () {
	return gulp.src(path.resolve('./theme/index.css'))
		...
		.pipe(cssWrap({
			selector: '.envision-theme' /* 添加的命名空间 */
		}))
		.pipe(cleanCSS())
		.pipe(gulp.dest('src/element-ui-theme/element-envision/')) /* 存放的目录 */
})
gulp.task('move-font', function () {
	return gulp.src(['./theme/fonts/**']).pipe(gulp.dest('src/element-ui-theme/element-envision/fonts'))
})
